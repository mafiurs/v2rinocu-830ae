        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            {/* <img
              ...
              alt="Company name"
            /> */}
            <span className="font-bold bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent text-base">
              RINOCU.COM
            </span>
            <p className="text-base text-gray-300">
              Providing the best tools for the crypto investor.
            </p>
              ...
              <div>
                ...
                <ul role="list" className="mt-4 space-y-2">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-sm text-gray-400 hover:text-gray-200">
                        {item.name}
                      </a>
                    </li>
                  ))}
